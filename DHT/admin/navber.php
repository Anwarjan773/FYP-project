    ...
    <div class="collapse navbar-collapse" id="adminNavbar">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'doctor_appointments.php') echo 'active'; ?>" href="doctor_appointments.php">
            <i class="fas fa-building me-1"></i>Doctor_appointments
          </a>
        </li>
