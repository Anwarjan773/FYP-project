...
// Close the doctor profile section when dismiss button is clicked
document.addEventListener("DOMContentLoaded", function () {
  const closeBtn = document.getElementById("closeDoctorProfile");
  const profileSection = document.querySelector(".doctor-profile-section");

  if (closeBtn && profileSection) {
    closeBtn.addEventListener("click", function () {
      profileSection.classList.add("d-none"); // hide the section
      // Optionally, update the URL to remove ?doctor_id=...
